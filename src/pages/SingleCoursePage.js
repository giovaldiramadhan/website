...
const SingleCoursePage = () => {
  ...
  const actualImage = course_images[image];
    ...
    <SingleCourseWrapper>
      <div className="course-intro mx-auto grid">
        <div className="course-img">
          <img src={actualImage} alt={course_name} />
        </div>
        <div className="course-details">
          ...
          {/* Bagian harga sudah dihapus dari sini */}

          <div className="course-btn">
            <button type="button" className="enroll-btn d-inline-block fw-7 bg-purple" onClick={handleEnroll}>
              Enroll Course
            </button>
          </div>
        </div>
